...
{
    public class CollapsingBallFire : BaseState
    {
        public static float baseDuration = SparkBallFire.baseDuration;

        public static GameObject projectilePrefab = CollapsingSparkBall.collapsingSparkBallProjectile;
        ...
        public static float bombForce = SparkBallFire.bombForce;
